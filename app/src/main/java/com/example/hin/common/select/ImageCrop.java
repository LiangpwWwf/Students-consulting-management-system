...
public abstract class ImageCrop {
    ...
    /**
     * @param data 裁剪对象，若为null，则从系统相册中选取图片进行裁剪。
     * @param out  裁剪结果的输出地址，若为null。则裁剪结果通过
     ...
     * 进入系统裁剪界面。
     *
     * @param ctx 当前activity。需要重写此activity的onActivityResult方法并调用
    ...
    public interface OnCropResultListener {
         ...
         * 裁剪结果的回调
         *
         * @param bmp 如果构造函数的outUri参数为null，则此参数不为null，反之该参数为null。
         */
