...
public class TimeUtils {
    ...
    public static String formatTimestampDay(long timestamp) {
        String date = new SimpleDateFormat("HH:mm:ss").format(new Date(timestamp * 1000));
        return date;
    }
    ...
    public static boolean isCurrentDay(long startTime, long serverTime) {
        ...
        Timestamp ts2 = new Timestamp(serverTime);
        Date date2 = new Date();
        date2 = ts2;
    ...
    public static int calculateHourLess(String serverTime, String createTime) {
        BigDecimal b1 = new BigDecimal(serverTime);
        BigDecimal b2 = new BigDecimal(createTime);
        BigDecimal h = new BigDecimal(86400);
        BigDecimal offset = b1.subtract(b2);
        int hour = offset.divide(h, 0, BigDecimal.ROUND_HALF_UP).intValue();
        if (hour <= 24) {
            return hour;
        }
        return 0;
    ...
    public static String calculatePercent(String number, String percent) {
        if (TextUtils.isDigitsOnly(number) && TextUtils.isDigitsOnly(percent)) {
            int n = Integer.parseInt(number);
            float p = Integer.parseInt(percent) / 100.0f;
            int r = (int) (n * p);
            return r + "";
        }
        return "";
